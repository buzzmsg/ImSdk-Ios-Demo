...
/**
 The TMTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for TMTextView objects. 
 ...
 */
@protocol TMTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(TMTextView *)textView;
- (BOOL)textViewShouldEndEditing:(TMTextView *)textView;
- (void)textViewDidBeginEditing:(TMTextView *)textView;
- (void)textViewDidEndEditing:(TMTextView *)textView;
- (BOOL)textView:(TMTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(TMTextView *)textView;
- (void)textViewDidChangeSelection:(TMTextView *)textView;

- (BOOL)textView:(TMTextView *)textView shouldTapHighlight:(TMTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TMTextView *)textView didTapHighlight:(TMTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(TMTextView *)textView shouldLongPressHighlight:(TMTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TMTextView *)textView didLongPressHighlight:(TMTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The TMTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+TMText.h for more convenience methods to set the attributes.
 See TMTextAttribute.h and TMTextLayout.h for more information.
 */
@interface TMTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<TMTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is TMTextVerticalAlignmentTop.
 */
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and TMTextAttribute.
 See `NSAttributedString+TMText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `TMTextParser` protocol for more information.
 */
@property (nullable, nonatomic, strong) id<TMTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) TMTextLayout *textLayout;
...
/**
 ...
 See `TMTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<TMTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [TMTextDebugOption sharedDebugOption].
 */
...
@property (nonatomic) IBInspectable TMTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const TMTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const TMTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const TMTextViewTextDidEndEditingNotification;
