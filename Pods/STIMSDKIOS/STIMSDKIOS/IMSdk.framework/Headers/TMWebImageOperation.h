...
/**
 The TMWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface TMWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) TMImageCache      *cache;    ///< The image cache.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(TMWebImageOptions)options
                          cache:(nullable TMImageCache *)cache
