 ...
 */
+ (nullable UIImage *)tm_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)tm_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)tm_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)tm_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (void)tm_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips;
 ...
 */
- (nullable UIImage *)tm_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)tm_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)tm_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)tm_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)tm_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)tm_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)tm_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)tm_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)tm_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)tm_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)tm_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)tm_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)tm_imageByBlurRadius:(CGFloat)blurRadius
