...
@class TMTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The TMTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface TMTextAsyncLayer : CALayer
...
/**
 The TMTextAsyncLayer's delegate protocol. The delegate of the TMTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol TMTextAsyncLayerDelegate <NSObject>
@required
/// This method is called to return a new display task when the layer's contents need update.
- (TMTextAsyncLayerDisplayTask *)newAsyncDisplayTask;
@end


/**
 A display task used by TMTextAsyncLayer to render the contents in background queue.
 */
@interface TMTextAsyncLayerDisplayTask : NSObject
