...
/**
 The TMLabel class implements a read-only text view.
 ...
 */
@interface TMLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is TMTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) TMTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TMTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TMTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) TMTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) TMTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `TMTextLayout` class in background thread. Here's an example:
    
    TMLabel *label = [TMLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        text.TM_font = [UIFont systemFontOfSize:16];
        text.TM_color = [UIColor grayColor];
        [text TM_setColor:[UIColor redColor] range:NSMakeRange(0, 4)];
 
        // Create text container
        TMTextContainer *container = [TMTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        TMTextLayout *layout = [TMTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<TMTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) TMTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) TMTextAction textTapAction;
@property (nullable, nonatomic, copy) TMTextAction textLongPressAction;
@property (nullable, nonatomic, copy) TMTextAction highlightTapAction;
@property (nullable, nonatomic, copy) TMTextAction highlightLongPressAction;
