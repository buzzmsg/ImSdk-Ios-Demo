...
/**
 TMTextTransaction let you perform a selector once before current runloop sleep.
 */
@interface TMTextTransaction : NSObject
 ...
 */
+ (TMTextTransaction *)transactionWithTarget:(id)target selector:(SEL)selector;
