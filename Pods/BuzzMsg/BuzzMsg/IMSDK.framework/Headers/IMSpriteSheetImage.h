...
/**
 ...
 Sample Code:
    ...
    IMSpriteSheetImage *sprite;
    sprite = [[IMSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    IMAnimatedImageView *imgView = [IMAnimatedImageView new];
