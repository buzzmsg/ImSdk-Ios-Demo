...
@class TMMemoryCache, TMDiskCache;
...
/**
 TMImageCache is a cache that stores UIImage and image data based on memory cache and disk cache.
...
/**
 ...
 @discussion When fetch image from disk cache, it will use 'TMImage' to decode 
...
/**
 ...
 @return  The singleton TMImageCache instance.
 */
