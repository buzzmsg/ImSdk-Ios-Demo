...
#import <TMWebImage/TMImageCache.h>
#else
#import "TMImageCache.h"
#endif

@class TMWebImageOperation;
...
typedef NS_OPTIONS(NSUInteger, TMWebImageOptions) {
    ...
    /// Use NSURLCache instead of TMImageCache.
 ...
 */
@interface TMWebImageManager : NSObject

/**
 Returns global TMWebImageManager instance.
 
 @return TMWebImageManager shared instance.
 */
 ...
 */
- (instancetype)initWithCache:(nullable TMImageCache *)cache
 ...
 */
- (nullable TMWebImageOperation *)requestImageWithURL:(NSURL *)url
 ...
 */
@property (nullable, nonatomic, strong) TMImageCache *cache;
...
/**
 ...
 @param url A specified URL
 @return Cache key used in TMImageCache.
 */
