...
/**
 ...
 Example:
     ...
     TMTextRunDelegate *delegate = [TMTextRunDelegate new];
     delegate.ascent = 20;
     delegate.descent = 4;
     delegate.width = 20;
 ...
 */
@interface TMTextRunDelegate : NSObject <NSCopying, NSCoding>

/**
 Creates and returns the CTRunDelegate.
 
 @discussion You need call CFRelease() after used.
 The CTRunDelegateRef has a strong reference to this TMTextRunDelegate object.
 In CoreText, use CTRunDelegateGetRefCon() to get this TMTextRunDelegate object.
