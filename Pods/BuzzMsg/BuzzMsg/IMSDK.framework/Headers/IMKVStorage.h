...
/**
 IMKVStorage is a key-value storage based on sqlite and file system.
 Typically, you should not use this class directly.
 
 @discussion The designated initializer for IMKVStorage is `initWithPath:type:`. 
 ...
 */
@interface IMKVStorage : NSObject
