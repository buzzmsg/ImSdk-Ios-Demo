...
@class TMTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The TMTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol TMTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable TMTextDebugOption *)option;
@end



/**
 The debug option for TMText.
 */
@interface TMTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (void)addDebugTarget:(id<TMTextDebugTarget>)target;
...
/**
 ...
 @param target A debug target.
 */
+ (void)removeDebugTarget:(id<TMTextDebugTarget>)target;
 ...
 */
+ (nullable TMTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable TMTextDebugOption *)option;
