...
/**
 TMKVStorageItem is used by `TMKVStorage` to store key-value pair and meta data.
...
/**
 TMKVStorage is a key-value storage based on sqlite and file system.
 Typically, you should not use this class directly.
 
 @discussion The designated initializer for TMKVStorage is `initWithPath:type:`. 
