...
/// Magnifier type
typedef NS_ENUM(NSInteger, TMTextMagnifierType) {
    TMTextMagnifierTypeCaret,  ///< Circular magnifier
    TMTextMagnifierTypeRanged, ///< Round rectangle magnifier
};

/**
 A magnifier view which can be displayed in `TMTextEffectWindow`.
 
 @discussion Use `magnifierWithType:` to create instance.
 Typically, you should not use this class directly.
 */
@interface TMTextMagnifier : UIView

/// Create a mangifier with the specified type. @param type The magnifier type.
+ (id)magnifierWithType:(TMTextMagnifierType)type;

@property (nonatomic, readonly) TMTextMagnifierType type;  ///< Type of magnifier
...
@property (nonatomic) BOOL captureDisabled;               ///< A hint for `TMTextEffectWindow` to disable capture.
