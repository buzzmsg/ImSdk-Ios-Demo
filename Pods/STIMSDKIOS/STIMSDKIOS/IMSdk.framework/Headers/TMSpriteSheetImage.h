...
/**
 ...
 The animation can be played by TMAnimatedImageView.
 ...
 Sample Code:
    ...
    TMSpriteSheetImage *sprite;
    sprite = [[TMSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    TMAnimatedImageView *imgView = [TMAnimatedImageView new];
