...
/**
 ...
 display with TMAnimatedImageView.
 
 Subclass a UIImage and implement this protocol, so that instances of that class 
 can be set to TMAnimatedImageView.image or TMAnimatedImageView.highlightedImage
 to display animation.
 
 See `TMImage` and `TMFrameImage` for example.
 */
