 ...
 *********************************************************************************
 *
 * 在使用TMLEETheme的过程中如果出现bug请及时以以下任意一种方式联系我，我会及时修复bug
 *
 * QQ    : 可以添加SDAutoLayout群 497140713 在这里找到我(LEE 332459523)
 * Email : 18611401994@163.com
 * GitHub: https://github.com/lixiang1994/IMLEETheme
...
@interface IMLEETheme (JsonModeExtend)
...
/// 获取当前主题值【值对象 (UIColor或UIImage或NSString 如为不存在则返回nil)】
/// @param identifier 标识符
+ (id)getCurrentTagValueWithIdentifier:(NSString *)identifier;

@end

@interface TMLEEThemeConfigModel : NSObject
...
@interface TMLEEThemeConfigModel (IdentifierModeExtend)
...
@interface TMLEEThemeIdentifier : NSString

+ (TMLEEThemeIdentifier *)ident:(NSString *)ident;

@end

@interface NSObject (TMLEEThemeConfigObject)

@property (nonatomic , strong ) TMLEEThemeConfigModel *tmm_lee_theme;

@end

@interface UIColor (TMLEEThemeColor)
