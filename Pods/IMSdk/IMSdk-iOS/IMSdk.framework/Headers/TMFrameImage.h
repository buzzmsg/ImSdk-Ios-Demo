...
/**
 ...
 Sample Code:
     ...
     TMFrameImage *image = [TMFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     TMAnimatedImageView *imageView = [TMAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface TMFrameImage : UIImage <TMAnimatedImage>
...
/**
 ...
 @return An initialized TMFrameImage object, or nil when an error occurs.
 */
