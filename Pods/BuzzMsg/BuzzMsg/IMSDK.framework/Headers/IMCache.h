//
//  IMCache.h
//  IMCache <https://github.com/ibireme/IMCache>
//
...
/**
 `IMCache` is a thread safe key-value cache.
 
 It use `IMMemoryCache` to store objects in a small and fast memory cache,
 and use `IMDiskCache` to persisting objects to a large and slow disk cache.
 See `IMMemoryCache` and `IMDiskCache` for more information.
 */
...
/** The underlying memory cache. see `IMMemoryCache` for more information.*/
@property (strong, readonly) IMMemoryCache *memoryCache;

/** The underlying disk cache. see `IMDiskCache` for more information.*/
@property (strong, readonly) IMDiskCache *diskCache;
