 ...
 */
@interface IMWebImageManager : NSObject

/**
 Returns global IMWebImageManager instance.
 
 @return IMWebImageManager shared instance.
 */
 ...
 */
- (instancetype)initWithCache:(nullable IMImageCache *)cache
 ...
 */
@property (nullable, nonatomic, strong) IMImageCache *cache;
...
/**
 ...
 @param url A specified URL
 @return Cache key used in IMImageCache.
 */
