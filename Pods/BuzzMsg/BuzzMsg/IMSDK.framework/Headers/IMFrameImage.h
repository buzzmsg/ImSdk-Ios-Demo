...
/**
 ...
 The animation can be played by IMAnimatedImageView.
 
 Sample Code:
     
     NSArray *paths = @[@"/ani/frame1.png", @"/ani/frame2.png", @"/ani/frame3.png"];
     NSArray *times = @[@0.1, @0.2, @0.1];
     IMFrameImage *image = [IMFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
...
/**
 ...
 @return An initialized IMFrameImage object, or nil when an error occurs.
 */
