...
/**
 ...
 Use -[TMTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} TMTextKeyboardTransition;


/**
 The TMTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol TMTextKeyboardObserver <NSObject>
@optional
- (void)keyboardChangedWithTransition:(TMTextKeyboardTransition)transition;
@end


/**
 A TMTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface TMTextKeyboardManager : NSObject
 ...
 */
- (void)addObserver:(id<TMTextKeyboardObserver>)observer;
 ...
 */
- (void)removeObserver:(id<TMTextKeyboardObserver>)observer;
